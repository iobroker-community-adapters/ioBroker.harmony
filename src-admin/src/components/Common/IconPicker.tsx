...
const DEVICE_ICONS: IconOption[] = [
    ...
    { id: 'device_light_stb', file: 'device_light_stb_white.png', label: 'Light STB' },
    { id: 'device_game', file: 'device_game_white.png', label: 'Game Console' },
    { id: 'device_game_shield', file: 'device_game_shield_white.png', label: 'Shield' },
    { id: 'device_game_xboxone', file: 'device_game_xboxone_white.png', label: 'Xbox One' },
    { id: 'device_game_xbox360', file: 'device_game_xbox360_white.png', label: 'Xbox 360' },
    { id: 'device_game_xbox', file: 'device_game_xbox_white.png', label: 'Xbox' },
    { id: 'device_game_wii', file: 'device_game_wiiw.png', label: 'Wii' },
    { id: 'device_wiiu', file: 'device_wiiu_white.png', label: 'Wii U' },
    { id: 'device_sonyps3', file: 'device_sonyps3_white.png', label: 'PlayStation 3' },
    { id: 'device_sonyps4', file: 'device_sonyps4_white.png', label: 'PlayStation 4' },
    ...
    { id: 'device_amazonstick', file: 'device_amazonstick_white.png', label: 'Fire Stick' },
    { id: 'device_apple', file: 'device_apple_white.png', label: 'Apple TV' },
    { id: 'device_nexusplayer', file: 'device_nexusplayer_white.png', label: 'Nexus Player' },
    { id: 'device_lrevue', file: 'device_icon_lrevue_white.png', label: 'Logitech Revue' },
    { id: 'device_tvcamhd', file: 'device_tvcamhd_white.png', label: 'TV Cam HD' },
    { id: 'device_light', file: 'device_light_on.png', label: 'Light' },
    { id: 'device_light_off', file: 'device_light_off_w.png', label: 'Light Off' },
    { id: 'device_lock', file: 'device_lock_white.png', label: 'Lock' },
    { id: 'device_unlocked', file: 'device_unlocked_white.png', label: 'Unlocked' },
    { id: 'device_plug', file: 'device_plug_white.png', label: 'Plug/Switch' },
    { id: 'device_sensor', file: 'device_sensor_white.png', label: 'Sensor' },
    { id: 'device_presense_sensor', file: 'device_presense_sensor_white.png', label: 'Presence Sensor' },
    { id: 'device_nest_sensor', file: 'device_nest_sensor.png', label: 'Nest Sensor' },
    { id: 'device_nestprotect', file: 'device_nestprotect_white.png', label: 'Nest Protect' },
    { id: 'device_blind', file: 'device_blind_white.png', label: 'Blind/Cover' },
    { id: 'device_waterheater', file: 'device_waterheater_white.png', label: 'Water Heater' },
    { id: 'device_cross', file: 'device_cross_white.png', label: 'Cross' },
